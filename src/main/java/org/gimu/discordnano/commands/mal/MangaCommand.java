...
public class MangaCommand {
	...
	private static String searchMAL(String query) {
        ...
        try {
            ...
            String api = "http://myanimelist.net/api/manga/search.xml?q=" + encodedQuery;
            URL url = new URL(api);
            ...
            return "__Query result__\n\n" + result.toString() + "\nList temporarily saved. Write `" + DiscordNano.prefix + "manga view <index>` to examine an entry.";
        } catch (Exception e) {
