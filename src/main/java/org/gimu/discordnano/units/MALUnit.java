 ...
 */
package org.gimu.discordnano.units;
...
public class MALUnit {
    ...
    private static HashMap<Integer, MALInfo> animeMap = new HashMap<>(); // Cache
    private static HashMap<Integer, MALInfo> mangaMap = new HashMap<>();

    private static long lastExecution = 0L;

    public static void viewRecent(NanoMessage message, boolean isAnime) {
        if (isAnime) {
            if (animeMap.isEmpty() && mangaMap.isEmpty()) {
    ...
    public static void view(NanoMessage message, String index) {
    ...
    public static void search(NanoMessage message, String query) {
